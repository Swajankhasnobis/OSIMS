...
public class UpdateTeacherDetails extends JFrame implements ActionListener
{
    ...
    UpdateTeacherDetails(String tec_id, String account)
    {
        ...
        try
        {
            ...
            {
                query="select username from teacher where tid='"+tec_id+"'";
            }
        ...
        l11=new JLabel("Age");
        l13=new JLabel("Dob");
        l14=new JLabel("Experience");
        l15=new JLabel("Fav Subject");
        ...
        ch1.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseClicked(MouseEvent arg0)
            {
                try
                {
                    ...
                    String q1="select * from teacher where username='"+username+"'";
                    ...
                    while(rest1.next())
                    {
                        ...
                        tf12.setText(rest1.getString("fav_subject"));
                    }
                }
                catch(Exception exx)
                {
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==bt1)
        {
            ...
            String fav_subj=tf12.getText();

            try
            {
                ConnectionClass obj3=new ConnectionClass();
                String q1="update teacher set name='"+name+"', email='"+email+"', father_name='"+fname+"', phone='"+phone+"',qualification='"+qualification+"', city='"+city+"', gender='"+gender+"', blood='"+blood+"', age='"+age+"', dob='"+dob+"', experience='"+experience+"', fav_subject='"+fav_subj+"' where username='"+username+"'";
                int aa=obj3.stm.executeUpdate(q1);
                if(aa==1)
                {
                    JOptionPane.showMessageDialog(null, "Teacher details successfully Updated");
   ...
   public static void main(String[] args)
    {
        new UpdateTeacherDetails("12253","admin").setVisible(true);
    }
}
