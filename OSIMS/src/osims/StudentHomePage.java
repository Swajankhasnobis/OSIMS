...
public class StudentHomePage extends JFrame implements ActionListener
{
    ...
    StudentHomePage(String stu_id, String username, String account, String class_name, String section)
    {
        ...
        ImageIcon ic=new ImageIcon(ClassLoader.getSystemResource("osims/icon/student home.jpg"));
        Image img=ic.getImage().getScaledInstance(1280,780,Image.SCALE_SMOOTH);
        ImageIcon ic1=new ImageIcon(img);
        l1=new JLabel(ic1);

        JMenuBar m1=new JMenuBar();
        JMenu men1=new JMenu("Student Profile");
        JMenuItem ment2=new JMenuItem("Update Student Profile");
        JMenuItem ment3=new JMenuItem("View Student Profile");

        JMenu men2=new JMenu("Teacher Profile");
        JMenuItem ment6=new JMenuItem("View Teacher Details");
...
//        ment13.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(comnd.equals("Update Student Profile"))
        {
        ...
        else if(comnd.equals("View Student Profile"))
        {
            //new ViewStudent(account2,id).setVisible(true);
        }
        ...
        {
            System.out.println(class_name2 + section2);
           // new ShowResult(username2,account2,class_name2,section2).setVisible(true);
        }
